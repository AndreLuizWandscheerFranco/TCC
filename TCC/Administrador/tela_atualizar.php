    ...
    <body>
        ...
        <div class="form-container">
            ...
            <form action="atualizar_produto.php" method="POST" enctype="multipart/form-data">
                <input type="text" name="id" value="<?php echo ($id_produto); ?>" placeholder="ID do produto" required>
                <input type="text" name="nome" value="<?php echo ($nome); ?>" placeholder="Nome do produto" required>
                <input type="number" name="valor" value="<?php echo ($valor); ?>" placeholder="Valor (R$)" step="0.01"
                    required>
                <input type="text" name="fabricante" value="<?php echo ($fabricante); ?>" placeholder="Fabricante"
                    required>
                ...
                <input type="number" name="avaliacao" value="<?php echo ($avaliacao); ?>"
                    placeholder="Avaliação (1 a 5)" min="1" max="5" required>
                <input type="number" name="id_pagamento" value="<?php echo ($nome); ?>"
